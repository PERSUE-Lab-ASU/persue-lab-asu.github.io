...
![]({{ site.url }}{{ site.baseurl }}/img/projects/privacyplay.jpg) Children join online games and social platforms at very young ages, but they learn almost nothing about how their data can be linked together to identify them. Privacy techniques like differential privacy and k-anonymity already protect data at Apple, Google, and the US Census Bureau, yet these concepts are only taught at the university level. Most middle schoolers still believe a made-up username keeps them anonymous.
